        ...
        <main>
            ...
            <div class="form-container">
                ...
                <div class="form-row photo-row">
                    <label>Sua foto (deixe vazio para manter)<br><span class="photo-text">Ela aparecerá no seu perfil</span></label>
                    <div class="photo-input-container">
                        <div class="photo-preview <?php echo !empty($this->request->data['ServiceProvider']['photo']) ? 'has-image' : ''; ?>" id="photo-preview">
                            <?php if (!empty($this->request->data['ServiceProvider']['photo'])): ?>
                                <?php echo $this->Html->image($this->request->data['ServiceProvider']['photo'], array('alt' => 'Foto atual')); ?>
                            <?php else: ?>

<div class="row justify-content-center">
    <div class="col-lg-10"> <div class="card-doity">
            <h2 class="fw-bold mb-1 fs-3">Cadastro de Prestador de Serviço</h2>

            <div class="mt-4 mb-4">
                <h5 class="fw-bold mb-1" style="font-size: 1.1rem;">Informações pessoais</h5>
                <p class="text-muted small">Cadastre suas informações e adicione uma foto.</p>
            </div>
            ...
            <div class="d-flex justify-content-end gap-3">
                ...
                <button type="submit" class="btn btn-danger px-4">Salvar Cadastro</button>
            </div>
...
$(document).ready(function() {
    var serviceIndex = 1; // Começa em 1 porque o 0 já existe na tela

    // Adicionar novo serviço
    $('#btn-add-service').click(function() {
        var template = $('#service-template').html();

        // Substitui o placeholder {INDEX} pelo número atual (1, 2, 3...)
        // Isso cria name="data[Service][1][name]", etc.
